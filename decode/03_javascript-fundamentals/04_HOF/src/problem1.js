...
//  console.log(callNoException(throwsZero, 0)) //returns null
//  console.log(callNoException(throwsZero, 12)) //returns 12
...
// console.log(callNoNull(nullZero, 0)) // throws an exception
// console.log(callNoNull(nullZero, 12)) // returns 12
